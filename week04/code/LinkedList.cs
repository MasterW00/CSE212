...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        else
        {
            ...
            newNode.Prev = _tail; // Connect the newNode to the precvious tail
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                {
                    curr.Prev!.Next = curr.Next; // Connect new node to the node containing 'value'
                    curr.Next!.Prev = curr.Prev; // Connect new node to the node after 'value'
                    curr.Next = null;
                    curr.Prev = null;
                }
